...
const EditPostMenu: FC<EditPostMenuProps> = ({ onEdit }) => {
  return (
    <Menu as="div" className="relative text-gray-400 ">
      ...
      >
        <Menu.Items className="absolute z-40 p-2 mt-1 space-y-2 bg-black rounded-md -right-1 w-36 shadow-app-shadow">
          <Menu.Item>
            {({ active }) => (
              <button
                onClick={onEdit}
